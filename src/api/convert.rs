...
// Registry Package and Template conversions are handled inline in
// client.rs (Route B) to work around API/spec mismatches.
...
mod tests {
    ...
    // Registry Package and Template conversions are handled inline in client.rs (Route B)
