...
/// Parse markdown content into styled spans (returns owned data)
fn parse_markdown_line(text: &str, theme: &Theme) -> Vec<Span<'static>> {
...
fn render_markdown_content(content: &str, theme: &Theme, indent: &str) -> Vec<Line<'static>> {
